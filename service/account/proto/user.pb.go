...
func (m *ReqUserFile) GetStatus() int32 {
	if m != nil {
		return m.Status
	}
	return 0
...
type ReqUserFileRename struct {
	...
	OldFilename          string   `protobuf:"bytes,4,opt,name=oldFilename,proto3" json:"oldFilename,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ReqUserFileRename) GetOldFilename() string {
	if m != nil {
...
func (m *ReqUserFileDelete) GetFilename() string {
	if m != nil {
		return m.Filename
	}
	return ""
...
func (m *ReqUserFileDelete) GetStatus() int32 {
	if m != nil {
		return m.Status
	}
	return 0
...
var fileDescriptor_116e343673f7ffaf = []byte{
	...
	,
}
